...
import {mockAdminUser, mockHouseholdUserDavide, mockHouseholdUserMarco} from "./MockUsers";
...
describe('InMemoryUserRepository', () => {
    ...
    describe('addNewHouseholdUser', () => {
        ...
        it('should add new user successfully', async () => {
            const result = await repository.addNewHouseholdUser(mockHouseholdUserMarco);
        ...
        it('should throw ConflictError when username already exists', async () => {
            ...
            await expect(repository.addNewHouseholdUser(mockHouseholdUserMarco))
    ...
    describe('updateUser', () => {
        ...
        beforeAll(async () => {
            repository.clear()
            householdUser = await repository.addNewHouseholdUser(mockHouseholdUserMarco);
        })
        ...
        it('should throw error when user not found', async () => {
            ...
            await expect(repository.updateUser(nonExistentUser))
                .rejects.toThrow(NotFoundError);
        });

        it('should throw ConflictError when new username conflicts', async () => {
            const newUser = await repository.addNewHouseholdUser(mockHouseholdUserDavide);
            const updatedUser = {
                ... householdUser,
                username: newUser.username,
            };

            await expect(repository.updateUser(updatedUser))
                .rejects.toThrow(ConflictError);
        });
    })
    ...
    describe('removeUser', () => {
        ...
        it('should throw error when user not found', async () => {
            ...
            await expect(repository.removeUser(nonExistentUser))
                .rejects.toThrow(NotFoundError);
        });
    })
